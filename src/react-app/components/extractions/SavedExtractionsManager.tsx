...
interface SavedExtractionsManagerProps {
  isOpen: boolean;
  onClose: () => void;
  onLoadExtraction: (extractionId: string) => void;
  onDeleteExtraction: (extractionId: string) => void;
}

export const SavedExtractionsManager: React.FC<SavedExtractionsManagerProps> = ({
  isOpen,
  onClose,
  onLoadExtraction,
  onDeleteExtraction,
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold">Saved Extractions</h2>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => onLoadExtraction(extraction.id)}
